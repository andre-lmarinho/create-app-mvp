...
This directory contains modular, machine-readable engineering rules for this codebase.
...
Our engineering philosophy is:

> We are building a software that must be reliable, secure, and maintainable. The rules in this directory encode the specific practices that enable this.
