...
This folder contains design documents for features in development. AI agents read these to understand what to build and track progress.

## How It Works

1. **Before implementing a feature**, create a spec folder with design docs
2. **The agent reads the design** before writing any code
...
| File/Folder | Purpose |
|-------------|---------|
| `AGENTS.md` | Instructions for agents when working on this feature |
...
The agent will read `implementation.md` to pick up where it left off.
